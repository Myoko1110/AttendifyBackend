...
SECRET_KEY = 'django-insecure-gfex57+t6vve+5+)kj0m6e%e_t*_!++g^a5eo&_w9bwk2txw7&'
...
SESSION_MAX_AGE = 60 * 60 * 24 * 30 * 6

with open("allowed_users.yml", "r") as f:
    ALLOWED_USER = yaml.safe_load(f)['allow_users']
